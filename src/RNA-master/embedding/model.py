...
from tensorflow.python.keras.layers import Concatenate, dot, CuDNNGRU
from tensorflow.python.keras.models import Model, load_model
from tensorflow.python.keras.regularizers import l1, l2, L1L2
from tensorflow.python.keras import backend as K
import tensorflow as tf

from attention_decoder import AttentionLayer, LuongAttention
...
class RNA2STRUCTURE:
    ...
    def Attention_Model(self, nodes=100, reg=0.0, dropout=0.0, batch_size=16):
        ...
        decoder_input = Input(
            batch_shape=(batch_size, self.max_sequence_length_dec - 1, self.N_words),
            dtype='float32')
    ...
    def InferFromHot(self, encoder_input):
    ...
    def InferFromEmbedding(self, encoder_input):

        decoded_basepairs = '3' # s.o.s. char
        decoder_input = np.zeros((1, 1))
        decoder_input[0, 0] = self.Coder.base_to_int[decoded_basepairs]
