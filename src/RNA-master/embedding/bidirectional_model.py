...
from tensorflow.python.keras.layers import Multiply, Add, Dense, Input, Dense, Dropout, Activation, BatchNormalization
from tensorflow.python.keras.layers import Dropout, LSTM, GRU, Bidirectional, TimeDistributed
from tensorflow.python.keras.layers import Concatenate, dot, Conv1D, MaxPooling1D
from tensorflow.python.keras.models import Model, load_model
from tensorflow.python.keras.regularizers import l1, l2, L1L2
from tensorflow.python.keras import backend as K

from attention_decoder import AttentionLayer, AttentionLayerVAE
...
class RNA2STRUCTURE:
    ...
    def Base_Model(self, nodes=100, reg=1e-8, dropout=0.5, batch_size=16):
        ...
        encoder_input = Input(
            shape=(self.max_sequence_length_enc, self.N_words),
            sparse=True,
            dtype='float32')
    ...
    def Attention_Model(self, nodes=100, reg=0.0, dropout=0.0, batch_size=16):
        ...
        encoder_out, encoder_fwd_state, encoder_back_state = encoder(encoder_input)
        ...
        encoder_inf_out, encoder_inf_fwd_state, encoder_inf_back_state = encoder(encoder_inf_inputs)
    ...
    def InferBasePairs(self, encoder_input):
        ...
        enc_outs, enc_fwd_state, enc_back_state = self.encoder_model.predict(
            encoder_input)
        dec_state = Add()([enc_fwd_state, enc_back_state])
